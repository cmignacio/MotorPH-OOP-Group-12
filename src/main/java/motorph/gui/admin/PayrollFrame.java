...
public class PayrollFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                downloadPayslipButtonActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(payrollTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void downloadPayslipButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_downloadPayslipButtonActionPerformed
        downloadPayslip();
    }//GEN-LAST:event_downloadPayslipButtonActionPerformed
...
private void downloadPayslip() {
    String payslipText = resultTextArea.getText().trim();

    if (payslipText.isEmpty() || payslipText.equals("Payroll results will appear here.")) {
        JOptionPane.showMessageDialog(this, "No payslip available to download.");
        return;
    }
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        try (java.io.PrintWriter writer = new java.io.PrintWriter(fileToSave)) {
            ...
            writer.println("====================");
            writer.println("Employee: " + employeeComboBox.getSelectedItem());
            writer.println("Month: " + monthComboBox.getSelectedItem());
            writer.println("Week: " + weekComboBox.getSelectedItem());
            writer.println();
            writer.println(payslipText);

            JOptionPane.showMessageDialog(this, "Payslip downloaded successfully.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error saving payslip: " + e.getMessage());
        }
    }
}
